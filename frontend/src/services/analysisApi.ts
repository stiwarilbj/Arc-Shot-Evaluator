...
const HOSTED_EXAMPLES: Array<Omit<ExampleVideo, "url">> = [
  { id: "example-1", label: "Rockets vs Kings · Demo", filename: "20.0-26.0.mp4", duration: 30.23, width: 640, height: 360, fps: 29.97, supported_modes: ["free_throw", "jump_shot"] },
  { id: "example-2", label: "Celtics vs Pelicans · Clip 01", filename: "9d07df92-9175-9d5f-0b91-5ded80044c3e_1280x720.mp4", duration: 7.05, width: 1280, height: 720, fps: 60, supported_modes: ["free_throw", "jump_shot"] },
  { id: "example-3", label: "Celtics vs Pelicans · Clip 02", filename: "70b413a5-8796-119b-f09d-a60370eff456_1280x720.mp4", duration: 7.05, width: 1280, height: 720, fps: 60, supported_modes: ["free_throw", "jump_shot"] },
  { id: "example-4", label: "Celtics vs Pelicans · Clip 03", filename: "195d59e5-bee1-0f97-3f5d-25144f1dba0e_1280x720.mp4", duration: 7.08, width: 1280, height: 720, fps: 60, supported_modes: ["free_throw", "jump_shot"] },
  { id: "example-5", label: "Celtics vs Pelicans · Clip 04", filename: "500ed956-1d96-21c6-0901-2444bace171d_1280x720.mp4", duration: 6.58, width: 1280, height: 720, fps: 60, supported_modes: ["free_throw", "jump_shot"] },
  { id: "example-6", label: "Celtics vs Pelicans · Clip 05", filename: "5927dc9e-af89-0ed3-ab1f-8a0acdfdf7be_1280x720.mp4", duration: 7.03, width: 1280, height: 720, fps: 60, supported_modes: ["free_throw", "jump_shot"] },
  { id: "example-7", label: "Celtics vs Pelicans · Clip 06", filename: "6780e35b-0ddf-cba1-a979-1c2634c51eea_1280x720.mp4", duration: 9.13, width: 1280, height: 720, fps: 60, supported_modes: ["free_throw", "jump_shot"] },
  { id: "example-8", label: "Celtics vs Pelicans · Clip 07", filename: "a9dbfe7f-11d3-b580-fefc-dc310cdd9e0d_1280x720.mp4", duration: 9.35, width: 1280, height: 720, fps: 60, supported_modes: ["free_throw", "jump_shot"] },
  { id: "example-9", label: "Celtics vs Pelicans · Clip 08", filename: "a090504f-62b8-9820-fb69-58fecfd5fe12_1280x720.mp4", duration: 8.03, width: 1280, height: 720, fps: 60, supported_modes: ["free_throw", "jump_shot"] },
  { id: "example-10", label: "Celtics vs Pelicans · Clip 09", filename: "aa7dbd16-c28f-b2a5-9a73-264418c65c4b_1280x720.mp4", duration: 6.05, width: 1280, height: 720, fps: 60, supported_modes: ["free_throw", "jump_shot"] },
